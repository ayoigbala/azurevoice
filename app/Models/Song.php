...
class Song extends Model implements HasMedia
{
    ...
    protected $appends = ['artwork_url', 'artists', 'album', 'permalink_url', 'stream_url', 'favorite', 'library', 'streamable', 'allow_download', 'allow_high_quality_download', 'subscription_url'];
