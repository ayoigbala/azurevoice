...
[![Latest Stable Version](https://poser.pugx.org/azurevoice/laravel-selfupdater/v/stable?format=flat-square)](https://packagist.org/packages/azurevoice/laravel-selfupdater)
[![Total Downloads](https://poser.pugx.org/azurevoice/laravel-selfupdater/downloads?format=flat-square)](https://packagist.org/packages/azurevoice/laravel-selfupdater)
[![](https://github.com/azurevoice/laravel-selfupdater/workflows/Tests/badge.svg)](https://github.com/azurevoice/laravel-selfupdater/actions)
[![StyleCI](https://styleci.io/repos/64463948/shield)](https://styleci.io/repos/64463948)
[![Codacy Badge](https://api.codacy.com/project/badge/Grade/dd836e58656b4e25b34b2a4ac8197142)](https://www.codacy.com/app/azurevoice/laravel-selfupdater?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=azurevoice/laravel-selfupdater)
[![codecov](https://codecov.io/gh/azurevoice/laravel-selfupdater/branch/master/graph/badge.svg)](https://codecov.io/gh/azurevoice/laravel-selfupdater)
...
```sh
$ composer require azurevoice/laravel-selfupdater
```
...
Select the branch that should be used via the `use_branch` setting [inside the configuration](https://github.com/azurevoice/laravel-selfupdater/blob/master/config/self-update.php).
